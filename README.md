...
| [hjsplit](http://www.freebyte.com) | [`hjsplit.json`](bucket/hjsplit.json) | `3.0` | Freeware standalone file splitter and joiner utility for Windows. | `scoop install nautilus-bucket/hjsplit` |
