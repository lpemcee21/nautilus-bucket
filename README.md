...
|-----|----------|---------|-------------|-----------------|
| [augre](https://getaugre.com/) | [`augre.json`](bucket/augre.json) | `0.1.37` | Free desktop EPUB reader that reads books aloud with on-device AI voices. | `scoop install nautilus-bucket/augre` |
